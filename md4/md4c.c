...
// $Id: md4c.c 9 2000-02-03 22:57:19Z jkf $
...
static void MD4Transform (u_int32_t [4], const unsigned char [64]);
...
MD4_CTX *context;					 /* context */
{
  ...
  if (digest != NULL) {
     ...
     */
    MemSet ((POINTER)context, sizeof (*context), 0);
  }
}
